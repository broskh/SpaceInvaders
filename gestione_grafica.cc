...
void stampaMenuPrincipale (Menu menu_principale, bool redraw_lampeggio, bool partita_salvata)
{
	...
	al_draw_tinted_bitmap_region(alieno_tipo_1, al_map_rgb(0, 255, 0), 0, 0, larghezzaAlieno1 (), al_get_bitmap_height (alieno_tipo_1), POS_X_ESEMPIO_ALIENI - al_get_bitmap_width (alieno_tipo_1) / (N_STATI_SPRITE * 2), pos_y_attuale, 0);
	...
	al_draw_tinted_bitmap_region(alieno_tipo_2, al_map_rgb(0, 255, 0), 0, 0, larghezzaAlieno2 (), al_get_bitmap_height (alieno_tipo_2), POS_X_ESEMPIO_ALIENI - al_get_bitmap_width (alieno_tipo_2) / (N_STATI_SPRITE * 2), pos_y_attuale, 0);
	...
	al_draw_tinted_bitmap_region(alieno_tipo_3, al_map_rgb(0, 255, 0), 0, 0, larghezzaAlieno3 (), al_get_bitmap_height (alieno_tipo_3), POS_X_ESEMPIO_ALIENI - al_get_bitmap_width (alieno_tipo_3) / (N_STATI_SPRITE * 2), pos_y_attuale, 0);
...
void stampaGioca (Partita partita, bool animazione, bool animazione_esplosione_carro)
{
	...
	{
		al_draw_tinted_bitmap(navicella_misteriosa, al_map_rgb(255, 0, 0), partita.navicella_misteriosa.pos_x, MARGINE_SUP_GIOCO, 0);
	}
	...
	{
		al_draw_tinted_bitmap(sparo_carro, al_map_rgb(0, 255, 0), partita.carro_armato.sparo.pos_x, partita.carro_armato.sparo.pos_y, 0);
	}
	...
	if (partita.carro_armato.esplosione)
	{
		...
		al_draw_tinted_bitmap_region(esplosione_carro, al_map_rgb(0, 255, 0), sx, 0, al_get_bitmap_width (esplosione_carro) / N_STATI_SPRITE, al_get_bitmap_height (esplosione_carro), partita.carro_armato.pos_x, MARGINE_INF_GIOCO - al_get_bitmap_height (esplosione_carro), 0);
	}
	else
	{
		al_draw_tinted_bitmap(carro_armato, al_map_rgb(0, 255, 0), partita.carro_armato.pos_x, MARGINE_INF_GIOCO - al_get_bitmap_height (carro_armato), 0);
	}
