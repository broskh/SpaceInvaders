OBJ = SpaceInvaders.o funzioni_generiche.o gestione_impostazioni.o gestione_highscores.o gestione_partita.o gestione_menu.o gestione_grafica.o gestione_audio.o
